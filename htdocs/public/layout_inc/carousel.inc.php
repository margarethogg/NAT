...
<article class="column_666_wide float_left">
	<h1 class="accessible">CAROUSEL</h1>
	
	<!-- Empty container for jQuery Carousel -->
	<div id="car_wrap" class="autoplay">
		<div class="car_photos"> </div>
		<div class="car_caption">
			<div class="car_caption_content"> </div>
		</div>
